...
void SendData(int Command, unsigned int yValue,unsigned int xValue){
  ...
  if(yValue == 0){
    ...
    //    Serial.println(previousYvalue);
//      Serial.print("x value = ");
//        Serial.println(xValue);
    previousYvalue = 0;
    // reset readings update maximum do something with the led
    int xValueMapped = map(xValue,260,110,-10,330);
    xValueMapped = min(xValueMapped, 255);
    xValueMapped = max(xValueMapped, 0);
    //delay(100);
    
//    Serial.print("x valuemapped = ");
//        Serial.println(xValueMapped);
    analogWrite(ledPin, xValueMapped);
...
//
//    } 
//    else if(xValueMapped > 50){
//
//      analogWrite(ledPin, 60);
//
//    }
//    else if (xValueMapped > 10){
