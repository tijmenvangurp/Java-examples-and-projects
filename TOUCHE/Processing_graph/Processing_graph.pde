Graph MyArduinoGraph = new Graph(150, 80, 1500, 900, color (200, 20, 20));
...
String[] names = {"off", "bright", "brighter","brightest"};
void setup() {
    println( Serial.list() );
...
void draw() {
  ...
  if ( DataRecieved3 ) {
...

    {
      ...
      //  gesturePoints[i][0] = 
      if (mousePressed && mouseX > 1475 && mouseX<1525 && mouseY > 100*(i+1) && mouseY < 100*(i+1) + 50)
      {
        fill(255, 0, 0);
   ...
   //calucalte individual dist
    ...
    //       text(names[i],50,450);
      ...
      stroke(0, 0, 0);
      rect(1500, 100 * (i+1), 50, 50);
      fill(0,0,0);
      textSize(30);
      text(names[i],1560,100 * (i+1)+25);
